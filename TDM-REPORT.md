...
>
> Дата сборки: 2026-06-24 · Источников: 22 файлов.
...
15. [Схемы](#15-Схемы) — `tdm/schemas/README.md`
16. [Код бота · README](#16-Код-бота-·-readme) — `tdm/bot/README.md`
17. [Код бота · app.schema](#17-Код-бота-·-appschema) — `tdm/bot/config/app.schema.md`
18. [Код бота · Деплой](#18-Код-бота-·-Деплой) — `tdm/bot/docs/DEPLOYMENT.md`
19. [Код бота · Engine](#19-Код-бота-·-engine) — `tdm/bot/src/engine/README.md`
20. [Код бота · OrderManager](#20-Код-бота-·-ordermanager) — `tdm/bot/src/newManagers/OrderManager/README.md`
21. [Код бота · Orchestrator](#21-Код-бота-·-orchestrator) — `tdm/bot/src/newManagers/orchestrator/README.md`
22. [Код бота · Transport](#22-Код-бота-·-transport) — `tdm/bot/src/transport/Readme.md`
