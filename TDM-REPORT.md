...
>
> Дата сборки: 2026-06-24 · Источников: 32 файлов.
...
4. [ADR-001 · Архитектура (Вариант 3, серверный FSM)](#4-adr-001-·-Архитектура-Вариант-3-серверный-fsm) — `tdm/docs/architecture-decision-variant3.md`
5. [Домен · Глоссарий](#5-Домен-·-Глоссарий) — `tdm/docs/domain/glossary.md`
6. [Домен · Модель заказа](#6-Домен-·-Модель-заказа) — `tdm/docs/domain/order-model.md`
7. [Домен · Модели исполнения](#7-Домен-·-Модели-исполнения) — `tdm/docs/domain/execution-models.md`
8. [Домен · Бизнес-правила](#8-Домен-·-Бизнес-правила) — `tdm/docs/domain/business-rules.md`
9. [Order-FSM · Состояния и переходы](#9-order-fsm-·-Состояния-и-переходы) — `tdm/docs/order-fsm/states.md`
10. [Order-FSM · Каркас серверного FSM-ядра (strawman)](#10-order-fsm-·-Каркас-серверного-fsm-ядра-strawman) — `tdm/docs/order-fsm/fsm-core-design.md`
11. [Order-FSM · Маппинг на backend](#11-order-fsm-·-Маппинг-на-backend) — `tdm/docs/order-fsm/backend-mapping.md`
12. [Order-FSM · Справочник payload API](#12-order-fsm-·-Справочник-payload-api) — `tdm/docs/order-fsm/api-payload-reference.md`
13. [Order-FSM · События](#13-order-fsm-·-События) — `tdm/docs/order-fsm/events.md`
14. [Order-FSM · Команды](#14-order-fsm-·-Команды) — `tdm/docs/order-fsm/commands.md`
15. [Order-FSM · Таймеры](#15-order-fsm-·-Таймеры) — `tdm/docs/order-fsm/timers.md`
16. [Интеграция · Контракт Order Gateway](#16-Интеграция-·-Контракт-order-gateway) — `tdm/docs/integration/order-gateway-contract.md`
17. [Интеграция · Контракт B0 (Бот ↔ Domain API)](#17-Интеграция-·-Контракт-b0-Бот-↔-domain-api) — `tdm/docs/integration/bot-domain-api-contract.md`
18. [Интеграция · Версионирование/совместимость API (дополнение к B0)](#18-Интеграция-·-Версионированиесовместимость-api-дополнение-к-b0) — `tdm/docs/domain-api-contract.md`
19. [Bot-FSM · Спецификация DSL](#19-bot-fsm-·-Спецификация-dsl) — `tdm/docs/bot-fsm/dsl-spec.md`
20. [Bot-FSM · Модель событий](#20-bot-fsm-·-Модель-событий) — `tdm/docs/bot-fsm/event-model.md`
21. [Bot-FSM · Форма (сбор данных)](#21-bot-fsm-·-Форма-сбор-данных) — `tdm/docs/bot-fsm/form-fsm.md`
22. [Bot-FSM · Сопровождение / UI Resolver](#22-bot-fsm-·-Сопровождение-ui-resolver) — `tdm/docs/bot-fsm/tracking-fsm.md`
23. [Gap-анализ](#23-gap-анализ) — `tdm/docs/gap-analysis.md`
24. [План реализации](#24-План-реализации) — `tdm/docs/implementation-plan.md`
25. [Схемы](#25-Схемы) — `tdm/schemas/README.md`
26. [Код бота · README](#26-Код-бота-·-readme) — `tdm/bot/README.md`
27. [Код бота · app.schema](#27-Код-бота-·-appschema) — `tdm/bot/config/app.schema.md`
28. [Код бота · Деплой](#28-Код-бота-·-Деплой) — `tdm/bot/docs/DEPLOYMENT.md`
29. [Код бота · Engine](#29-Код-бота-·-engine) — `tdm/bot/src/engine/README.md`
30. [Код бота · OrderManager](#30-Код-бота-·-ordermanager) — `tdm/bot/src/newManagers/OrderManager/README.md`
31. [Код бота · Orchestrator](#31-Код-бота-·-orchestrator) — `tdm/bot/src/newManagers/orchestrator/README.md`
32. [Код бота · Transport](#32-Код-бота-·-transport) — `tdm/bot/src/transport/Readme.md`
...
## 4. ADR-001 · Архитектура (Вариант 3, серверный FSM)
...
## 9. Order-FSM · Состояния и переходы
...
## 10. Order-FSM · Каркас серверного FSM-ядра (strawman)
...
## 11. Order-FSM · Маппинг на backend
...
## 12. Order-FSM · Справочник payload API
...
## 16. Интеграция · Контракт Order Gateway
...
## 17. Интеграция · Контракт B0 (Бот ↔ Domain API)
...
## 18. Интеграция · Версионирование/совместимость API (дополнение к B0)
...
## 22. Bot-FSM · Сопровождение / UI Resolver
