...
>
> Дата сборки: 2026-06-24 · Источников: 31 файлов.
...
10. [Order-FSM · Маппинг на backend](#10-order-fsm-·-Маппинг-на-backend) — `tdm/docs/order-fsm/backend-mapping.md`
11. [Order-FSM · Справочник payload API](#11-order-fsm-·-Справочник-payload-api) — `tdm/docs/order-fsm/api-payload-reference.md`
12. [Order-FSM · События](#12-order-fsm-·-События) — `tdm/docs/order-fsm/events.md`
13. [Order-FSM · Команды](#13-order-fsm-·-Команды) — `tdm/docs/order-fsm/commands.md`
14. [Order-FSM · Таймеры](#14-order-fsm-·-Таймеры) — `tdm/docs/order-fsm/timers.md`
15. [Интеграция · Контракт Order Gateway](#15-Интеграция-·-Контракт-order-gateway) — `tdm/docs/integration/order-gateway-contract.md`
16. [Интеграция · Контракт B0 (Бот ↔ Domain API)](#16-Интеграция-·-Контракт-b0-Бот-↔-domain-api) — `tdm/docs/integration/bot-domain-api-contract.md`
17. [Интеграция · Доменный API-контракт (ядро ↔ бот)](#17-Интеграция-·-Доменный-api-контракт-ядро-↔-бот) — `tdm/docs/domain-api-contract.md`
18. [Bot-FSM · Спецификация DSL](#18-bot-fsm-·-Спецификация-dsl) — `tdm/docs/bot-fsm/dsl-spec.md`
19. [Bot-FSM · Модель событий](#19-bot-fsm-·-Модель-событий) — `tdm/docs/bot-fsm/event-model.md`
20. [Bot-FSM · Форма (сбор данных)](#20-bot-fsm-·-Форма-сбор-данных) — `tdm/docs/bot-fsm/form-fsm.md`
21. [Bot-FSM · Сопровождение / UI Resolver](#21-bot-fsm-·-Сопровождение-ui-resolver) — `tdm/docs/bot-fsm/tracking-fsm.md`
22. [Gap-анализ](#22-gap-анализ) — `tdm/docs/gap-analysis.md`
23. [План реализации](#23-План-реализации) — `tdm/docs/implementation-plan.md`
24. [Схемы](#24-Схемы) — `tdm/schemas/README.md`
25. [Код бота · README](#25-Код-бота-·-readme) — `tdm/bot/README.md`
26. [Код бота · app.schema](#26-Код-бота-·-appschema) — `tdm/bot/config/app.schema.md`
27. [Код бота · Деплой](#27-Код-бота-·-Деплой) — `tdm/bot/docs/DEPLOYMENT.md`
28. [Код бота · Engine](#28-Код-бота-·-engine) — `tdm/bot/src/engine/README.md`
29. [Код бота · OrderManager](#29-Код-бота-·-ordermanager) — `tdm/bot/src/newManagers/OrderManager/README.md`
30. [Код бота · Orchestrator](#30-Код-бота-·-orchestrator) — `tdm/bot/src/newManagers/orchestrator/README.md`
31. [Код бота · Transport](#31-Код-бота-·-transport) — `tdm/bot/src/transport/Readme.md`
...
## 10. Order-FSM · Маппинг на backend
...
## 11. Order-FSM · Справочник payload API
...
## 15. Интеграция · Контракт Order Gateway
...
## 16. Интеграция · Контракт B0 (Бот ↔ Domain API)
...
## 17. Интеграция · Доменный API-контракт (ядро ↔ бот)
...
## 21. Bot-FSM · Сопровождение / UI Resolver
