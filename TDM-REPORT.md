...
>
> Дата сборки: 2026-06-24 · Источников: 23 файлов.
...
3. [Gap-анализ](#3-gap-анализ) — `tdm/docs/gap-analysis.md`
4. [Домен · Глоссарий](#4-Домен-·-Глоссарий) — `tdm/docs/domain/glossary.md`
5. [Домен · Модель заказа](#5-Домен-·-Модель-заказа) — `tdm/docs/domain/order-model.md`
6. [Домен · Модели исполнения](#6-Домен-·-Модели-исполнения) — `tdm/docs/domain/execution-models.md`
7. [Домен · Бизнес-правила](#7-Домен-·-Бизнес-правила) — `tdm/docs/domain/business-rules.md`
8. [Order-FSM · События](#8-order-fsm-·-События) — `tdm/docs/order-fsm/events.md`
9. [Order-FSM · Команды](#9-order-fsm-·-Команды) — `tdm/docs/order-fsm/commands.md`
10. [Order-FSM · Таймеры](#10-order-fsm-·-Таймеры) — `tdm/docs/order-fsm/timers.md`
...
13. [Bot-FSM · Спецификация DSL](#13-bot-fsm-·-Спецификация-dsl) — `tdm/docs/bot-fsm/dsl-spec.md`
14. [Интеграция · Контракт Order Gateway](#14-Интеграция-·-Контракт-order-gateway) — `tdm/docs/integration/order-gateway-contract.md`
15. [Интеграция · Доменный API-контракт (ядро ↔ бот)](#15-Интеграция-·-Доменный-api-контракт-ядро-↔-бот) — `tdm/docs/domain-api-contract.md`
16. [Схемы](#16-Схемы) — `tdm/schemas/README.md`
17. [Код бота · README](#17-Код-бота-·-readme) — `tdm/bot/README.md`
18. [Код бота · app.schema](#18-Код-бота-·-appschema) — `tdm/bot/config/app.schema.md`
19. [Код бота · Деплой](#19-Код-бота-·-Деплой) — `tdm/bot/docs/DEPLOYMENT.md`
20. [Код бота · Engine](#20-Код-бота-·-engine) — `tdm/bot/src/engine/README.md`
21. [Код бота · OrderManager](#21-Код-бота-·-ordermanager) — `tdm/bot/src/newManagers/OrderManager/README.md`
22. [Код бота · Orchestrator](#22-Код-бота-·-orchestrator) — `tdm/bot/src/newManagers/orchestrator/README.md`
23. [Код бота · Transport](#23-Код-бота-·-transport) — `tdm/bot/src/transport/Readme.md`
...
## 14. Интеграция · Контракт Order Gateway
...
## 15. Интеграция · Доменный API-контракт (ядро ↔ бот)
